...
<!--            <div style="box-shadow: 2px 2px 5px #bbb;border-radius:12px;margin-top:10px;">-->
                <div style="padding-left:10px;padding-top:20px;padding-bottom:20px;text-align:center;">
                    <img src="bootstrap-3.3.7/image/success.png" style="width:40px;height:40px;">
                    <div style="padding-top:5px;">
                        <label>Your request has been submitted. A team member will follow up with you as soon as possible.</label></div>
                </div>
<!--            </div>-->
        </div>
