...
<!--            </div>-->
        ...
        <div class="col-xs-12" style="padding-top:20px;">
            <button type="button" class="btn btn-sm btn-ubibot"
                    onclick="goback('<?php echo $requesterId; ?>','<?php echo $username; ?>','<?php echo $email; ?>')">
                Back
            </button>
        </div>
    </div>
...
<script type="application/javascript">
    function goback(token_id, username, email) {
        location.href = "create.php?token_id=" + token_id + "&user_name=" + decodeURI(username) + "&email=" + decodeURI(email);
    }
</script>
</body>
</html>
